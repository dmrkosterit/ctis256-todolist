  ...
  <div class="wrapper" id="box">
    ...
    <form action="" method="post">
      <div class="form-group">
        ...
        <input style='margin: 10px 10px 10px 10px;width:90%; background: #f2f2f2;border-radius: 3px;' type="text" value= "<?=$list['title']?>"autocomplete="off" id="title" name="title"></input>
      </div>
